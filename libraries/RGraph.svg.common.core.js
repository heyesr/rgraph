        ...
        if (opt.labels !== false) {
            ...
            if (properties.yaxisScale) {
                ...
                var text = RGraph.SVG.text({
                    ...
                    halign: (properties.yaxisPosition === 'right' || obj.properties.yaxisLabelsHalign === 'left' ? 'left' : 'right'),
                    valign: !RGraph.SVG.isNull(properties.yaxisLabelsValign) ? properties.yaxisLabelsValign : 'center',
    ...
    RGraph.SVG.drawTitle = function (obj)
    {
        ...
        if (
            ...
            RGraph.SVG.text({
                ...
                x:      x + (properties.titleSubtitleOffsetx || 0),
                y:      y + 5 + (properties.titleSubtitleOffsety || 0),
                halign: properties.titleHalign || 'center',
                valign: 'top',
...
*/
    ...
    //
    RGraph.SVG.getColors = function (colors = [])
    {
        var defaultColors = [
